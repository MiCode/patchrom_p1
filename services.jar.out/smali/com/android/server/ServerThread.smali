...
.method public run()V
    ...
    .line 127
    .local v57, factoryTestStr:Ljava/lang/String;
    const-string v3, ""
    ...
    .line 146
    .local v53, dock:Lcom/android/server/DockObserver;
    const/16 v93, 0x0
    ...
    .line 162
    invoke-static/range {v56 .. v56}, Lcom/android/server/am/ActivityManagerService;->main(I)Landroid/content/Context;
    ...
    .line 246
    .local v84, srvCfgClz:Ljava/lang/Class;
    ...
    .line 247
    .local v66, mLoadServices:Ljava/lang/reflect/Method;
    const/4 v3, 0x0
    ...
    .line 268
    .end local v66           #mLoadServices:Ljava/lang/reflect/Method;
    .end local v84           #srvCfgClz:Ljava/lang/Class;
    :goto_a
    const/4 v3, 0x1
    ...
    .line 299
    .local v51, devicePolicy:Lcom/android/server/DevicePolicyManagerService;
    const/16 v85, 0x0
    ...
    .line 350
    new-instance v52, Lcom/android/server/DevicePolicyManagerService;
    ...
    .line 351
    .end local v51           #devicePolicy:Lcom/android/server/DevicePolicyManagerService;
    ...
    .restart local v51       #devicePolicy:Lcom/android/server/DevicePolicyManagerService;
    :goto_12
    :try_start_13
    const-string v3, "SystemServer"
    ...
    .line 529
    new-instance v54, Lcom/android/server/DockObserver;
    ...
    .end local v53           #dock:Lcom/android/server/DockObserver;
    .local v54, dock:Lcom/android/server/DockObserver;
    move-object/from16 v53, v54

    .line 535
    .end local v54           #dock:Lcom/android/server/DockObserver;
    .restart local v53       #dock:Lcom/android/server/DockObserver;
    :goto_27
    :try_start_34
    const-string v3, "SystemServer"
    ...
    .line 613
    .local v78, pwrMgrntSrvClz:Ljava/lang/Class;
    const/4 v3, 0x1
    ...
    .line 614
    .local v50, ctor:Ljava/lang/reflect/Constructor;
    const/4 v3, 0x1
    ...
    .line 615
    .local v77, pwrMgrntSrv:Ljava/lang/Object;
    const-string v3, "bt_fm_radio"

    check-cast v77, Landroid/os/IBinder;

    .end local v77           #pwrMgrntSrv:Ljava/lang/Object;
    ...
    .line 625
    .end local v50           #ctor:Ljava/lang/reflect/Constructor;
    .end local v78           #pwrMgrntSrvClz:Ljava/lang/Class;
    :goto_31
    ...
    .line 641
    :try_start_40
    invoke-virtual/range {v51 .. v51}, Lcom/android/server/DevicePolicyManagerService;->systemReady()V
    :try_end_40
    ...
    .line 844
    .end local v61           #lastAirplaneMode:I
    :cond_6
    :goto_37
    ...
    .end local v51           #devicePolicy:Lcom/android/server/DevicePolicyManagerService;
    .end local v53           #dock:Lcom/android/server/DockObserver;
    .end local v56           #factoryTest:I
    .end local v57           #factoryTestStr:Ljava/lang/String;
    .end local v59           #imm:Lcom/android/server/InputMethodManagerService;
    .end local v62           #lights:Lcom/android/server/LightsService;
    .end local v64           #location:Lcom/android/server/LocationManagerService;
    ...
    .end local v79           #reason:Ljava/lang/String;
    .end local v80           #reboot:Z
    .restart local v57       #factoryTestStr:Ljava/lang/String;
    :cond_a
    ...
    .restart local v53       #dock:Lcom/android/server/DockObserver;
    .restart local v56       #factoryTest:I
    .restart local v62       #lights:Lcom/android/server/LightsService;
    ...
    const-string v9, "calling loadServices"
    ...
    :try_end_46
    .catch Ljava/lang/RuntimeException; {:try_start_46 .. :try_end_46} :catch_3
    ...
    :try_end_47
    .catch Ljava/lang/RuntimeException; {:try_start_47 .. :try_end_47} :catch_42
    ...
    .restart local v61       #lastAirplaneMode:I
    :cond_12
    :try_start_49
    invoke-virtual {v4}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;
