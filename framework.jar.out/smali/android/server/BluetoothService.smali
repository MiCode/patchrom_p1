...
.field private static final BRCM_CALL_STATE:Ljava/lang/String; = "broadcom.android.bluetooth.intent.CALL_STATE"

.field private static final BRCM_CALL_STATE_CHANGED_ACTION:Ljava/lang/String; = "broadcom.android.bluetooth.intent.action.CALL_STATE_CHANGED"
...
.method private declared-synchronized updateSdpRecords()V
    ...
    .local v0, bRst:Z
    :try_start_1
    const-string v6, "com.broadcom.bt.service.framework.BluetoothServiceConfig"
    ...
    const-string v6, "isServiceSupported"
    ...
    .line 752
    .local v3, mIsServiceSupported:Ljava/lang/reflect/Method;
    const/4 v6, 0x0
    ...
    .line 757
    .end local v3           #mIsServiceSupported:Ljava/lang/reflect/Method;
    ...
    const-string/jumbo v8, "pan1"

    invoke-virtual {p0, v6, v7, v8}, Landroid/server/BluetoothService;->setBluetoothTetheringNative(ZLjava/lang/String;Ljava/lang/String;)Z

    .line 772
    :goto_1
    sget-object v6, Landroid/bluetooth/BluetoothUuid;->AudioSource:Landroid/os/ParcelUuid;

    invoke-virtual {v5, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 779
    invoke-direct {p0, v5}, Landroid/server/BluetoothService;->addReservedSdpRecords(Ljava/util/ArrayList;)V
    ...
    new-array v6, v6, [Landroid/os/ParcelUuid;

    iput-object v6, p0, Landroid/server/BluetoothService;->mAdapterUuids:[Landroid/os/ParcelUuid;
    ...
    .line 785
    iget-object v7, p0, Landroid/server/BluetoothService;->mAdapterUuids:[Landroid/os/ParcelUuid;
    ...
    const-string v7, "calling isServiceSupported"
...
.method declared-synchronized shutoffBluetooth()V
    ...
    :try_start_0
    iget-object v4, p0, Landroid/server/BluetoothService;->mAdapterSdpHandles:[I

    if-eqz v4, :cond_0

    iget-object v4, p0, Landroid/server/BluetoothService;->mAdapterSdpHandles:[I

    invoke-direct {p0, v4}, Landroid/server/BluetoothService;->removeReservedServiceRecordsNative([I)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 582
    .local v3, srvCfgClz:Ljava/lang/Class;
    ...
    .line 583
    .local v2, mIsServiceSupported:Ljava/lang/reflect/Method;
    const/4 v4, 0x0
    ...
    .line 588
    .end local v2           #mIsServiceSupported:Ljava/lang/reflect/Method;
    .end local v3           #srvCfgClz:Ljava/lang/Class;
    :goto_0
    if-eqz v0, :cond_1
    ...
    const-string v5, "calling isServiceSupported"
    ...
    const-string v5, "Bluetooth PAN Profile is not supported"
